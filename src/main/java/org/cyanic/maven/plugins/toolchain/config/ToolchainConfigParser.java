...
public class ToolchainConfigParser extends AbstractConfigurationConverter {

    @Override
    public boolean canConvert(Class type) {
        return ToolchainConfig.class.isAssignableFrom(type);
    }
    ...
    private ToolchainConfig processConfiguration(PlexusConfiguration configuration) {
        ...
        return new ToolchainConfig(map);
    }
}